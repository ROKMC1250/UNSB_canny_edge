...
class ResnetGenerator(nn.Module):
    ...
    def forward(self, input, layers=[], encode_only=False):
        ...
        if len(layers) > 0:
            ...
            output3 = self.model3(input)
            output4 = self.model4(input)

            print('start_shape:',output1.shape)
            print('downsampling_shape:',output2.shape)
            print('resnet_shape:',output3.shape)
            print('upsampling_shape:',output4.shape)
